...
<a class="navbar-brand" href="#"><img src="img/bcci_logo.png" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy"> IPL AUCTION 2020</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto right">
      <li class="nav-item ">
        <a class="nav-link" href="playerprofile.php">My Profile <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item  ">
        ...
        <div class="row">
           <div class="col-md-3"></div>
            <div class="col-sm-12 col-md-6">
                <div class="buttons">
                    <button id="addNote" type="button" class="btn btn-info btn-lg">Updates</button>
                    <button id="edit" type="button" class="btn btn-info btn-lg float-right">Current Bid</button>
