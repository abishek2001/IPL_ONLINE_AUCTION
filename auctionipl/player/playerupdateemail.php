...
$sql = "SELECT * FROM playerusers WHERE email='$newemail'";
...
$sql = "SELECT * FROM playerusers WHERE user_id='$user_id'";
$result = mysqli_query($link, $sql);
...
//insert new email in the playerusers table
$sql = "UPDATE playerusers SET email='$newemail' WHERE user_id = '$user_id'";
$result = mysqli_query($link, $sql);
if(!$result){
