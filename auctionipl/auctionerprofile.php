...
<a class="navbar-brand" href="#"><img src="img/bcci_logo.png" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy"> IPL AUCTION 2020</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto right">
      ...
      <li class="nav-item  ">
        <a class="nav-link" href="#">Team Owner</a>
      </li>
      <li class="nav-item">
...
<div class="container" id="container">
  <div class="row">
     <div class="col-md-3"></div>
      ...
      <!--Update username-->
        <form method="post" id="updateusernameformauct">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div id="updateusernamemessageauct"></div>


                  <div class="form-group">
                      <label for="usernameauct" >Username:</label>
                      <input class="form-control" type="text" name="usernameauct" id="usernameauct" maxlength="30" value="<?php echo $username; ?>">
                  </div>
...
<div class="container " id="topp">
  <p>Auctioner's can update their username,email and password</p>
</div>
      <!--Update email-->
        <form method="post" id="updateemailformauct">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div id="updateemailmessageauct"></div>


                  <div class="form-group">
                      <label for="emailauct" >Email:</label>
                      <input class="form-control" type="email" name="emailauct" id="emailauct" maxlength="50" value="<?php echo $email ?>">
                  </div>
      ...
      <!--Update password-->
        <form method="post" id="updatepasswordformauct">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div id="updatepasswordmessageauct"></div>


                  <div class="form-group">
                      <label for="currentpasswordauct" class="sr-only" >Your Current Password:</label>
                      <input class="form-control" type="password" name="currentpasswordauct" id="currentpasswordauct" maxlength="30" placeholder="Your Current Password">
                  </div>
                  <div class="form-group">
                      <label for="passwordauct" class="sr-only" >Choose a password:</label>
                      <input class="form-control" type="password" name="passwordauct" id="passwordauct" maxlength="30" placeholder="Choose a password">
                  </div>
                  <div class="form-group">
                      <label for="password2auct" class="sr-only" >Confirm password:</label>
                      <input class="form-control" type="password" name="password2auct" id="password2auct" maxlength="30" placeholder="Confirm password">
                  </div>
